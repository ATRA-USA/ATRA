...
function getRallyStatusStrings(timing) {
    ...
    if (day === 5) {
        return {
            type: "tomorrow",
            track: `rally in &lt; 24hrs<span class="banner-track-space"></span><span class="highlight-b">tomorrow!</span><span class="banner-track-space"></span>updated live`,
            left: "Saturday,<br>1pm to 3pm",
...
function videoVolumeToggle(container) {
